...
class MPMT4: public Tool {


 public:

  MPMT4(); ///< Simple constructor
 ...
 private:
  ...
  std::vector<MPMT4_args*> args; ///< Vector of thread args (also holds pointers to the threads)
